...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    public static interface AnimateViewHolder {

        void preAnimateAddImpl(final ViewHolder holder);

        void preAnimateRemoveImpl(final ViewHolder holder);

        void animateAddImpl(final ViewHolder holder, ViewPropertyAnimatorListener listener);

        void animateRemoveImpl(final ViewHolder holder,
